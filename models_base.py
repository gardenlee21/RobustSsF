...
class Decoder_fuse(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4, mask):
        #x1=(1,4,16,80,80,80), x2=(1,4,32,40,40,40), x3=(1,4,64,20,20,20), x4=(1,4,128,10,10,10)
        import pdb; pdb.set_trace()
        prm_pred4 = self.prm_generator4(x4, mask) #(1,4,10,10,10)
        de_x4 = self.RFM4(x4, prm_pred4.detach(), mask) #(1,128,10,10,10)
        de_x4 = self.d3_c1(self.up2(de_x4)) #(1,128,10,10,10)->(1,64,40,40,40)->(1,64,20,20,20)
